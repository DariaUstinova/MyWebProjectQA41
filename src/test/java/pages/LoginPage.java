/* Задача*: дописать класс LoginPage* используя аннотации @FindBy
, создать два метода: fillPasswordField и clickByLoginButton по аналогии с fillEmailField и clickByRegisterButton*/
package pages;
